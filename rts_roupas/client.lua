...
Tunnel.bindInterface("rts_roupas", vRPrp)
mapreedevSERVER = Tunnel.getInterface("rts_roupas")


local lojaderoupa = {
    -- LOJA DE ROUPA 01
   -- { name = "Loja de Roupas", id = 73, color = 13, x = 70.87, y = -1399.49, z = 29.39, provador = {x = 70.87, y = -1399.49, z = 29.39, heading = 359.29}},
    { name = "Loja de Roupas", x = -1453.21, y = -237.78, z = 49.81, provador = {x = -1453.21, y = -237.78, z = 49.81, heading = 356.65}},
   ...
   -- { name = "Loja de Roupas", id = 73, color = 13, x = 430.1, y = -799.67, z = 29.52, provador = {x = 430.1, y = -799.67, z = 29.52, heading = 177.1}},
    { name = "Loja de Roupas", x = 427.28, y = -802.56, z = 29.5, provador = {x = 427.28, y = -802.56, z = 29.5, heading = 183.77}},
    { name = "Loja de Roupas", x = 429.28, y = -802.56, z = 29.5, provador = {x = 429.28, y = -802.56, z = 29.5, heading = 192.52}},
    { name = "Loja de Roupas", x = 425.52, y = -802.55, z = 29.5, provador = {x = 425.52, y = -802.55, z = 29.5, heading = 181.76}},
   ...
   -- { name = "Loja de Roupas", id = 73, color = 13, x = -1448.24, y = -235.21, z = 49.82, provador = {x = -1448.24, y = -235.21, z = 49.82, heading = 95.97}},
    { name = "Loja de Roupas", x = -1194.26, y = -772.99, z = 17.33, provador = {x = -1194.26, y = -772.99, z = 17.33, heading = 10.74}},
    { name = "Loja de Roupas", x = -1195.45, y = -771.37, z = 17.33, provador = {x = -1195.32, y = -771.37, z = 17.33, heading = 56.05}},
    { name = "Loja de Roupas", x = -1193.25, y = -774.35, z = 17.33, provador = {x = -1193.14, y = -774.35, z = 17.33, heading = 50.59}},
   ...
   -- { name = "Loja de Roupas", id = 73, color = 13, x = 1697.49, y = 4829.94, z = 42.07, provador = {x = 1697.49, y = 4829.94, z = 42.07, heading = 179.54}},
    { name = "Loja de Roupas", x = 1697.9, y = 4826.96, z = 42.07, provador = {x = 1697.9, y = 4826.96, z = 42.07, heading = 201.35}},
    { name = "Loja de Roupas", x = 1695.69, y = 4826.65, z = 42.07, provador = {x = 1695.67, y = 4826.8, z = 42.07, heading = 186.38}},
    { name = "Loja de Roupas", x = 1693.61, y = 4826.35, z = 42.07, provador = {x = 1693.61, y = 4826.41, z = 42.07, heading = 190.91}},
    ...
    while true do
        ...
        for k, v in pairs(lojaderoupa) do
            ...
            if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, lojaderoupa[k].x, lojaderoupa[k].y, lojaderoupa[k].z, true ) <= 8 and not in_loja and (cooldown == 0) then
                sleep = 4
                DrawMarker(27,lojaderoupa[k].x,lojaderoupa[k].y,lojaderoupa[k].z-1,0,0,0,0,180.0,130.0,1.0,1.0,1.0,148,0,211,55,0,0,0,1)        
            end
